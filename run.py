...
class QuestionGenerator:
    """class for generating questions and their answers depending on type_ and max_number"""
    ...
    def get_list_of_questions(self, total_question) -> List[QuestionInfo]:
        ...
        questions = []
        duplicates = 0
        while len(questions) < total_question:
...
class MathWorksheetGenerator:
    """class for generating pdf worksheet file depending on questions generated by QuestionGenerator class"""
    def __init__(self):
        self.pdf = FPDF()
...
def main(type_, size):
    ...
    question_generator = QuestionGenerator(type_, size)
    seed_question = question_generator.get_list_of_questions(new_pdf.total_question)
